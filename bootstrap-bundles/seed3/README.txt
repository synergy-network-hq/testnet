...
- Remote with token: curl -X DELETE -H "X-Seed-Admin-Token: <token>" http://seed3.synergynode.xyz:5621/peers

DNS
- Publish A record seed3.synergynode.xyz -> 64.227.107.57
- Optional SRV record: _synergy-seed._tcp.synergynode.xyz -> seed3.synergynode.xyz:5621
