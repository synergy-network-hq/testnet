...
DOMAINS=(
    ...
    "testnet-beta-wallet-api.synergy-network.io"
    "testnet-beta-faucet.synergy-network.io"
    "testnet-beta-sxcp-api.synergy-network.io"
    "testnet-beta-sxcp-ws.synergy-network.io"
    "testnet-beta-synq-verify.synergy-network.io"
)
