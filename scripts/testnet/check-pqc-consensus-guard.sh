...
PATTERN='k256|secp256k1|ecdsa|Ed25519|SYNERGY_CONSENSUS_ALLOW_GENESIS_STATUS_BYPASS|allow_genesis_status_bypass[[:space:]]*=[[:space:]]*true|return true;[[:space:]]*//[[:space:]]*Placeholder|simulate VRF|placeholder QC'
