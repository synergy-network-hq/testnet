...
# run-signed-load.sh
#
# Launch a signed-transaction load test against testnet-beta. Wraps
...
#
# Usage:
#   scripts/testbeta/run-signed-load.sh [options] [-- ...extra-args]
#
# Common options:
#   --rpc-url URL            JSON-RPC endpoint (default: public testbeta RPC)
...
#   --background             Run detached, log to scripts/testbeta/logs
...
SCRIPT_DIR="$ROOT_DIR/scripts/testbeta"
...
RPC_URL="${RPC_URL:-https://testbeta-core-rpc.synergy-network.io}"
SENDER="${SENDER:-}"
