...
BOOTNODES=(
  "bootnode1|64.227.107.57"
  "bootnode2|73.79.66.255"
  "bootnode3|74.208.227.23"
)
...
STATE = {"generated_at": None, "bootnodes": []}
...
Required A records
bootnode1.${DOMAIN} -> 64.227.107.57
bootnode2.${DOMAIN} -> 73.79.66.255
bootnode3.${DOMAIN} -> 74.208.227.23
seed1.${DOMAIN} -> 64.227.107.57
seed2.${DOMAIN} -> 73.79.66.255
seed3.${DOMAIN} -> 74.208.227.23
